...
public class ToHexStringEmptyFixturesTest extends ToHexStringTest {
    ...
    public static class _Benchmark {
        ...
        public void makePayloads(_Payloads payloads) {
            payloads.testRunWorkloadOnce = ToHexStringEmptyFixturesTest::testRunWorkloadOnce;
            payloads.testRunWorkloadTwice = ToHexStringEmptyFixturesTest::testRunWorkloadTwice;
            payloads.testRunWorkloadThrice = ToHexStringEmptyFixturesTest::testRunWorkloadThrice;
        }
    }
}
