...
public class ParseJavaSourceTimeoutRuleTest extends ParseJavaSourceTest {
    ...
    public static class _Benchmark {
        ...
        public void makePayloads(_Payloads payloads) {
            payloads.testRunWorkloadOnce = _ClassStatement.forPayload(ParseJavaSourceTimeoutRuleTest::testRunWorkloadOnce, "testRunWorkloadOnce", this);
            payloads.testRunWorkloadTwice = _ClassStatement.forPayload(ParseJavaSourceTimeoutRuleTest::testRunWorkloadTwice, "testRunWorkloadTwice", this);
            payloads.testRunWorkloadThrice = _ClassStatement.forPayload(ParseJavaSourceTimeoutRuleTest::testRunWorkloadThrice, "testRunWorkloadThrice", this);
        }
    }
}
