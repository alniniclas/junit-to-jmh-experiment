...
public class SqrtEmptyRulesTest extends SqrtTest {
    ...
    public static class _Benchmark {
        ...
        public void makePayloads(_Payloads payloads) {
            payloads.testRunWorkloadOnce = _ClassStatement.forPayload(SqrtEmptyRulesTest::testRunWorkloadOnce, "testRunWorkloadOnce", this);
            payloads.testRunWorkloadTwice = _ClassStatement.forPayload(SqrtEmptyRulesTest::testRunWorkloadTwice, "testRunWorkloadTwice", this);
            payloads.testRunWorkloadThrice = _ClassStatement.forPayload(SqrtEmptyRulesTest::testRunWorkloadThrice, "testRunWorkloadThrice", this);
        }
    }
}
